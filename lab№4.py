...
class ArtifactApp:
    ...
    def get_next_artifact_name(self):
        max_number = 3
        for artifact in self.artifacts:
            # Шукаємо максимальний номер серед файлів зображень, які мають формат artifactN.jpg
    ...
    def add_artifact(self):
        # Отримуємо назву артефакту з поля введення
        ...
        # Створюємо новий артефакт із введеною назвою та згенерованим ім'ям файлу зображення
